function mostrar_serie(Titulo, ListURL, PrevURL, NextURL, tabsLeng, tabsWeb) {
  ...
  <style>
    * {margin: 0; padding: 0; box-sizing: border-box;}
    ...
    /* Reproductores */
    #header .reproductores {flex: 1; justify-content: flex-end;}
  ...
  <div id="header">
    ...
    <div class="capitulos">
      <a href="`+PrevURL+`" `+PrevClass+` title="Anterior"><i class="fa fa-chevron-left"></i></a>
      <a href="`+ListURL+`" `+ListClass+` title="Lista"><i class="fa fa-list-dots"></i></a>
      <a href="`+NextURL+`" `+NextClass+` title="Siguiente"><i class="fa fa-chevron-right"></i></a>
    </div>
